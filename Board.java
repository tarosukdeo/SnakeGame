...
public class Board extends JPanel implements ActionListener {
    ...
    // Size of the apple and snake's head
    private final int DOT_SIZE = 10;

    // Maximum number of possible dots on the board
    private final int ALL_DOTS = 900;

    // Used to calculate a random position for an apple
    ...
    //Used to load the images for the game
    ...
    //Create the snake, randomly locate an apple and start the timer
    ...
    //Used to determine if the snake hits itself or one of the walls
    ...
    //Used to position a new apple randomly
